 ...
 *
 */
public class stdsPrint extends BasePrintXmlAction{
	...
	public void print(HttpServletResponse response, List<Map>list, Map info) throws IOException{
		...
		out.println (" <Worksheet ss:Name='學生'>");
		out.println ("  <Names>");
		out.println ("   <NamedRange ss:Name='Print_Titles' ss:RefersTo='stdsPrint!G1'/>");
		out.println ("  </Names>");
		out.println ("  <Table ss:ExpandedColumnCount='6' ss:ExpandedRowCount='"+list.size()+1+"' x:FullColumns='1'");		
		...
		out.println ("    <Cell><Data ss:Type='String'>共修學分</Data><NamedCell ss:Name='Print_Titles'/></Cell>");
		out.println ("    <Cell><Data ss:Type='String'>不及格學分</Data><NamedCell ss:Name='Print_Titles'/></Cell>");
		...
		for(int i=0; i<list.size(); i++){
			...
			out.println ("    <Cell><Data ss:Type='String'>"+list.get(i).get("total")+"</Data></Cell>");
		...
		out.println ("     x:Data='&amp;L&amp; &#10;人數: "+list.size()+" / "+info.get("allStds")+"&amp;C&amp;20 "+info.get("title")+" &amp;R&amp;D-&amp;T&#10;第&amp;P頁 共&amp;N頁'/>");
